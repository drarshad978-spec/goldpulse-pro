          ...
          >
            ...
            <div className="p-8 flex items-center justify-between border-b border-black/5 bg-black/5">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-black tracking-tighter text-black">GOLDPULSE <span className="text-amber-500 italic font-serif">PRO</span></span>
              ...
              <button 
                onClick={onClose}
                className="p-2 hover:bg-black/5 rounded-full transition-colors text-zinc-500 hover:text-black"
              >
                <X size={20} />
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto py-6 px-4 space-y-1 bg-white">
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-2xl transition-all group ${
                    activeSection === item.id 
                      ...
                      : 'hover:bg-black/5 text-zinc-500 hover:text-black border border-transparent'
                  }`}
                >
                  <div className={`p-2.5 rounded-xl transition-all ${
                    activeSection === item.id 
                      ? 'bg-amber-500 text-black shadow-[0_0_15px_rgba(245,158,11,0.4)]' 
                      : 'bg-zinc-900 text-zinc-500 group-hover:bg-zinc-800 group-hover:text-zinc-600'
                  }`}>
                    <item.icon size={18} />
                  </div>
              ...
              {secondaryItems.map((item) => (
                <button
                  key={item.id}
                  className="w-full flex items-center gap-4 p-4 rounded-2xl hover:bg-black/5 text-zinc-500 hover:text-black transition-all group"
                >
            ...
            <div className="p-8 border-t border-black/5 bg-black/5">
              <div className="bg-black/5 border border-black/5 rounded-2xl p-5 text-black relative overflow-hidden group cursor-pointer backdrop-blur-xl">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-black">Active Session</span>
