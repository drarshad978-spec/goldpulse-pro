...
export default function Calculator() {
  ...
  return (
    <div className="glass p-5 sm:p-8 rounded-3xl border-black/5 relative overflow-hidden group">
      ...
      <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 items-end relative z-10">
        <div className="flex-1 w-full">
          ...
          <input 
            ...
            className="w-full bg-black/5 border border-black/10 rounded-2xl px-4 sm:px-6 py-3 sm:py-4 text-zinc-900 font-bold focus:ring-2 focus:ring-amber-500/50 outline-none transition-all focus:bg-black/10"
          />
        </div>

        <div className="flex-[2] w-full grid grid-cols-2 gap-4 sm:gap-6">
          <div>
            ...
            <div className="relative">
              <select 
                ...
                className="w-full appearance-none bg-black/5 border border-black/10 rounded-2xl px-4 sm:px-6 py-3 sm:py-4 text-zinc-900 font-bold focus:ring-2 focus:ring-amber-500/50 outline-none transition-all focus:bg-black/10 cursor-pointer"
              >
        ...
        <div className="flex-1 w-full lg:border-l lg:border-black/5 lg:pl-8">
          ...
          <div className="text-2xl sm:text-4xl font-black text-zinc-900 tracking-tighter">
            <span className="text-amber-600 mr-2 text-xl sm:text-2xl">{symbol}</span>
